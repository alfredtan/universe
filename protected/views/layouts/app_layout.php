  ...
  (function() {
	...
	<body>
        ...
        <div id="tncModal" class="reveal-modal large">
            ...
            <h3>Eligibility</h3>
            <p>No  purchase or payment is required to participate in the contest. The Contest is  open to all SPM, STPM school leavers &amp; UEC 2011 exam leavers who are  registered participants at&nbsp;<a href="http://fb.com/inti.edu" target="_blank">fb.com/inti.edu</a> (&quot;<strong>Participant</strong>&quot;)  other than the employees of INTI and their immediate family members limited to  parents, spouse, children and siblings, INTI's associated agencies (advertising  and promotion agents), and their immediate family members. The participant must not have applied or enrolled in any Institutions of Higher Learning in Malaysia. The Participant must  be citizens or permanent residents of Malaysia above the age of eighteen (18)  years with a valid National Registration Identification Card (&ldquo;<strong>NRIC</strong>&rdquo;) number (12-digit) at the time of  participation of the Contest. Participant under the age of eighteen (18) must  seek parental and/or guardian&rsquo;s approval to participate. INTI reserves the absolute right to vary or amend the aforesaid eligibility criteria of Participant for the Contest if it shall deem necessary.<br /><br />
